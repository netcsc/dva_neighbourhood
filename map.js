...
function showToolTip(d, priceByName, crimeByName, pricedata) {
  ...
  tip = tip+"<strong>Price:</strong>" + formatNum(priceByName[d.properties.neighborhood]) + "<br/>";
  tip = tip+"<strong>Crime:</strong> $" + formatNum(crimeByName[d.properties.neighborhood])+ "<br/>";
